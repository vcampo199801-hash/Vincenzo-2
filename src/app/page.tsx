          ...
          <div className="mx-auto mt-8 flex max-w-xl flex-col items-center gap-3 rounded-xl border border-brand-200 bg-white px-6 py-4 shadow-sm sm:flex-row sm:justify-center sm:gap-6">
            ...
            <div className="flex flex-col items-center gap-2.5 sm:flex-row sm:gap-4">
              <a
                ...
                className="inline-flex items-center gap-1.5 whitespace-nowrap text-sm font-semibold text-emerald-700 hover:text-emerald-800"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 whitespace-nowrap text-sm font-semibold text-brand-700 hover:text-brand-800"
              >
                <svg viewBox="0 0 24 24" className="h-4 w-4 shrink-0 fill-current" aria-hidden>
